...
$("#submit1").click(() => {
    ...
    if ((gender != ('men' || 'women')) && (brand != ('zara' || 'hnm')) && (topOrBottom != ('top' || 'bottom'))) {
...
$(document).ready(() => {
    ...
    if (sex == 'men' && downUP == 'top') {
        categories = [
			'athletic', 'blazers', 'jackets', 'polos', 'seasonal', 'shirts', 'suits', 'sweatshirts', 'swimwear'];
    }
    else if (sex == 'men' && downUP == 'bottom') {
        categories = ['athletic', 'denim', 'shorts', 'trousers', 'swimwear', 'underwear'];
    }
    else if (sex == 'women' && downUP == 'top') {
        categories = ['athletic', 'blazers', 'collectionWear', 'jackets & coats'
						, 'maternity', 'nightwear', '+PLUS', 'shirts', 'suits', 'sweatshirts', 'swimwear'];
    }
    else if (sex == 'women' && downUP == 'bottom') {
        categories = ['athletic', 'denim', '+PLUS', 'shorts & skirts', 'tights', 'trousers', 'swimwear', 'underwear'];
    }
